...
@section('title', 'Edit Bill Detail')

@section('content')
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-md-6">
            <h2>Edit Bill Detail</h2>
        </div>
            ...
            <form action="{{ route('bill-details.update', $billDetail->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ $billDetail->date->format('Y-m-d') }}" required>
                        @error('date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('name_of_contractor') is-invalid @enderror" id="name_of_contractor" name="name_of_contractor" value="{{ $billDetail->name_of_contractor }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('name_of_work') is-invalid @enderror" id="name_of_work" name="name_of_work" value="{{ $billDetail->name_of_work }}" required>
                        @error('name_of_work')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('name_of_bank') is-invalid @enderror" id="name_of_bank" name="name_of_bank" value="{{ $billDetail->name_of_bank }}" required>
                        @error('name_of_bank')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('agreement_no') is-invalid @enderror" id="agreement_no" name="agreement_no" value="{{ $billDetail->agreement_no }}" required>
                        @error('agreement_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('work_order_amount') is-invalid @enderror" id="work_order_amount" name="work_order_amount" value="{{ $billDetail->work_order_amount }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('work_time_limit') is-invalid @enderror" id="work_time_limit" name="work_time_limit" value="{{ $billDetail->work_time_limit }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('dlp_period') is-invalid @enderror" id="dlp_period" name="dlp_period" value="{{ $billDetail->dlp_period }}" required>
                        @error('dlp_period')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('deduction_amount') is-invalid @enderror" id="deduction_amount" name="deduction_amount" value="{{ $billDetail->deduction_amount }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('net_bill_amount') is-invalid @enderror" id="net_bill_amount" name="net_bill_amount" value="{{ $billDetail->net_bill_amount }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('security_deposit') is-invalid @enderror" id="security_deposit" name="security_deposit" value="{{ $billDetail->security_deposit }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('insurance') is-invalid @enderror" id="insurance" name="insurance" value="{{ $billDetail->insurance }}" required>
                        @error('insurance')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('gst') is-invalid @enderror" id="gst" name="gst" value="{{ $billDetail->gst }}" required>
                        @error('gst')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('surcharge') is-invalid @enderror" id="surcharge" name="surcharge" value="{{ $billDetail->surcharge }}" required>
                        @error('surcharge')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('cess') is-invalid @enderror" id="cess" name="cess" value="{{ $billDetail->cess }}" required>
                        @error('cess')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('tds') is-invalid @enderror" id="tds" name="tds" value="{{ $billDetail->tds }}" required>
                        @error('tds')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('royalty') is-invalid @enderror" id="royalty" name="royalty" value="{{ $billDetail->royalty }}" required>
                        @error('royalty')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('fine') is-invalid @enderror" id="fine" name="fine" value="{{ $billDetail->fine }}" required>
                        @error('fine')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('other') is-invalid @enderror" id="other" name="other" value="{{ $billDetail->other }}" required>
                        @error('other')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('bank_charges') is-invalid @enderror" id="bank_charges" name="bank_charges" value="{{ $billDetail->bank_charges }}" required>
                        @error('bank_charges')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('stamp_duty') is-invalid @enderror" id="stamp_duty" name="stamp_duty" value="{{ $billDetail->stamp_duty }}" required>
                        @error('stamp_duty')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('gram_panchayat_emd') is-invalid @enderror" id="gram_panchayat_emd" name="gram_panchayat_emd" value="{{ $billDetail->gram_panchayat_emd }}" required>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('remark') is-invalid @enderror" id="remark" name="remark" rows="3">{{ $billDetail->remark }}</textarea>
                        @error('remark')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary">Update Bill Detail</button>
                </div>
            </form>
        </div>
    </div>
